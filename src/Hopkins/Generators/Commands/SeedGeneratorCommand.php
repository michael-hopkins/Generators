...
class SeedGeneratorCommand extends BaseGeneratorCommand {
     ...
     *
     * @var \Hopkins\Generators\Generators\Generators\SeedGenerator
     */
    protected $generator;
    ...
    {
        return array(
            array('path', null, InputOption::VALUE_OPTIONAL, 'Path to the seeds directory.', Config::get('generators.seed_target_path')),
